...
from pagge import extract_page
from ert import extract
import sys
...
with open(r"C:\Users\beugre niamba\Desktop\Analyse-interactions entres risques grace au Gen ai\Centralesupelec-LGI\auto_chunker\rt.md", "r", encoding="utf-8") as f:
    aloe_data = f.read()
    
with open(r"C:\Users\beugre niamba\Desktop\Analyse-interactions entres risques grace au Gen ai\Centralesupelec-LGI\auto_chunker\reponse.md") as f:
    objet_data = f.read()
...
output_md = r"C:\Users\beugre niamba\Desktop\Analyse-interactions entres risques grace au Gen ai\Centralesupelec-LGI\auto_chunker\reponse2.md"
with open(output_md, "a", encoding="utf-8") as md_file:
    for idx, (page_content, page_ctx, ordered_objet_content) in enumerate(zip(pages, pages_data, ordered_objet)):
        ...
        objet_content = ordered_objet_content
